  ...
  Phase 3: Polish & Deployment (Sprints 5 & 6)
   9. Module F (Physics - Part 2): Add uncertainty propagation (error bars) and friction compensation.
   10. Module K (Data Management): Add the database to save/load past experiments.
   11. Module L (Infrastructure): Finalize Docker configs for easy setup in a lab.