        ...
        <div className="absolute inset-0 pointer-events-none border-[40px] border-black/20">
          <div className="w-full h-full border-2 border-dashed border-white/30 rounded-lg flex items-start p-6">
            <div className="bg-black/40 backdrop-blur-sm px-3 py-2 rounded border border-white/10">
              <p className="text-[10px] uppercase font-bold tracking-widest text-white/70">Framing Guide</p>
              ...
              {recordState === 'uploading' && (
                <>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-slate-400 text-sm">Transferring high-speed capture to master session...</p>
                  </div>
      ...
      <div className="p-8 bg-slate-900 border-t border-white/5 flex flex-col items-center gap-4">
        {recordState === 'idle' && (
          <>
            ...
            <p className="text-slate-500 text-[10px] uppercase font-bold tracking-widest">Awaiting Master Command</p>
          </>
        )}
        ...
        {status === 'error' && (
          <div className="text-center space-y-2">
            ...
            <button onClick={() => window.location.reload()} className="text-indigo-400 text-sm underline pt-2">Reload App</button>
          </div>
        )}
      </div>
    </div>
